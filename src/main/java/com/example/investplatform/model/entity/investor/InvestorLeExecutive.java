...
@Entity
@Table(name = "investor_le_executives")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class InvestorLeExecutive {
    ...
    @JoinColumn(name = "investor_legal_entity_id", nullable = false)
    private InvestorLegalEntity investorLegalEntity;
    ...
    @Column(name = "mgmt_company_name", length = 500)
    private String mgmtCompanyName;

    @Column(name = "mgmt_company_ogrn", length = 13)
    private String mgmtCompanyOgrn;
}
